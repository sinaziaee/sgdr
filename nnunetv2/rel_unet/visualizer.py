...
ce_scores = pd.read_csv('/home/seyedsina.ziaee/datasets/v2_all/uncert_class_kidney/uncertainty_scores.csv')
te_scores = pd.read_csv('/home/seyedsina.ziaee/datasets/v2_all/uncert_total_entropy/uncertainty_scores.csv')
...
for image in images:
    try:
        ...
        te_map = nib.load('/home/seyedsina.ziaee/datasets/v2_all/uncert_total_entropy/' + image.replace("_0000","_uncertainty_map")).get_fdata()
        ...
        for slice_inx in range(depth):
            ...
            num = image.split("_")[1]
            os.makedirs(f"/home/seyedsina.ziaee/datasets/v2_all/temp_visualization/kits_{num}_uncertainty_maps", exist_ok=True)
            plt.savefig(f"/home/seyedsina.ziaee/datasets/v2_all/temp_visualization/kits_{num}_uncertainty_maps/slice_{slice_inx:04d}.png")
            plt.close()
