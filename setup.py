...
setup(name='nnunetv2',
      ...
      entry_points={
          'console_scripts': [
              ...
              'rel_UNet_run_uncertainty = nnunetv2.rel_unet.estimate_uncertainty:estimate_uncertainty', #
              'rel_UNet_predict = nnunetv2.rel_unet.predict_sgdr:predict_from_folder_entry', #
              'rel_UNet_predict_one_train_percent = nnunetv2.rel_unet.predict_one_train_percent:predict_from_folder_entry', #
